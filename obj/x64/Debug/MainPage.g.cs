#pragma checksum "C:\Users\slore\source\repos\VagtplanNy\MainPage.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "6EEDF975EC693DA181FB287B7897D779"
//------------------------------------------------------------------------------
// <auto-generated>
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
            ...
            IMainPage_Bindings
        {
            ...
            public void Disable(int lineNumber, int columnNumber)
            {
                ...
                else if (lineNumber == 28 && columnNumber == 85)
                {
                    isobj3TextDisabled = true;
                }
                else if (lineNumber == 29 && columnNumber == 88)
                {
            ...
            private void UpdateTwoWay_3_Text()
            {
                if (this.initialized)
                {
                    if (this.dataRoot != null)
                    {
                        ...
                        {
                            this.dataRoot.ViewModel.MedNavn = this.obj3.Text;
                        }
                    }
                }
            }
            private void UpdateTwoWay_4_Text()
            {
                if (this.initialized)
                {
                    if (this.dataRoot != null)
                    {
                        if (this.dataRoot.ViewModel != null)
                        {
                            this.dataRoot.ViewModel.MedTelefon = this.obj4.Text;
                        }
                    }
                }
            }
